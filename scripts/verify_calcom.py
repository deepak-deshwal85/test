...
async def main(phone_number: str) -> int:
    ...
    if event_types:
        ...
        for event_type in event_types:
            marker = " <-- configured" if event_type.slug == calcom.event_type_slug else ""
            print(
...
if __name__ == "__main__":
    ...
    raise SystemExit(asyncio.run(main("".join(ch for ch in parser.parse_args().phone if ch.isdigit()))))
